...
@RestController
public class TestSnappedPointsController {

    @GetMapping("testSnappedPoints")
    public Map testSnappedPoints() {
        ...
        double dist = 0.00001; // increment for each point
        LatLng[] destinations = getLocations(context, origin, dist);
